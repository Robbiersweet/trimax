...
export type SemanticRow = { id: string; bounds: Bounds; invoiceRegion?: Bounds; amountRegion?: Bounds; amountCents?: number | null };
...
export type DocumentSemanticModel = {
  ...
  table: { supported: boolean; headerPosition: Bounds | null; columns: SemanticColumn[]; rows: SemanticRow[] };
