...
export default function EstimatePrintErrorPage({
  reset,
}: {
    ...
    <main className="min-h-screen bg-white px-6 py-10 text-black">
      <div className="mx-auto max-w-3xl rounded-3xl border border-red-200 bg-red-50 p-8">
        ...
        <h1 className="mt-3 text-3xl font-black">
          This estimate print page could not load.
        </h1>
        <p className="mt-3 leading-7 text-red-950/80">
          Trimax could not prepare the printable estimate. The estimate itself
          is not deleted.
        </p>
